...
const updateContent = async (id: string, languageCode: string, updatedLanguage: UpdateLanguage) => {
  try {
    ...
    content.translations.set(languageCode, { ...existingTranslation, ...updatedLanguage });
    await content.save();
